...
class _CombinedReportScreenState extends State<CombinedReportScreen> {
  ...
  Future<void> _exportToExcel() async {
    ...
    if (fileBytes != null) {
      ...
      final file = File('${directory.path}/Combined_Report_$timestamp.xlsx');
        ...
        child: Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () => setState(() {
                _selectedBoard = null; _selectedStd = null; _selectedMedium = null; _selectedStream = null; _fetchData();
              }),
            )
          ],
        ),
