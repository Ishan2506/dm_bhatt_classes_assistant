...
class OneLinerReportScreen extends StatefulWidget {
  ...
  @override
  State<OneLinerReportScreen> createState() => _OneLinerReportScreenState();
}

class _OneLinerReportScreenState extends State<OneLinerReportScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final res = await ApiService.getExamReports(
        type: "ONELINER", // Filter by One-Liner Exams
  ...
  Future<void> _exportToExcel() async {
    ...
    Sheet sheetObject = excel["One-Liner Report"];
    excel.delete('Sheet1');
    sheetObject.appendRow([
      ...
      TextCellValue('Obtained'), TextCellValue('Total'), TextCellValue('Date'),
    ]);
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.format_list_numbered_rounded, color: Colors.teal.shade700, size: 24),
            ),
